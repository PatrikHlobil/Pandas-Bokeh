...
Release Notes can be found [here](https://github.com/PatrikHlobil/Pandas-Bokeh/blob/master/Release_Notes.md).

# Contributing to `Pandas-Bokeh`

If you wish to contribute to the development of `Pandas-Bokeh` you can follow the instructions on the [CONTRIBUTING.md](https://github.com/PatrikHlobil/Pandas-Bokeh/blob/master/CONTRIBUTING.md).
